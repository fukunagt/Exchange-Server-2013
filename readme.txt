========================================================================
    メイクファイル プロジェクト: Exchange-Server-2013 プロジェクトの概要
========================================================================

この Exchange-Server-2013 プロジェクトは、AppWizard により作成されました。

このファイルには、Exchange-Server-2013 プロジェクトを構成する各ファイルの内容の概略が記述されています。


Exchange-Server-2013.vcxproj
...
Exchange-Server-2013.vcxproj.filters
